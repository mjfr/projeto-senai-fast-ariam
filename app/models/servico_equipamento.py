...
class ServicoEquipamento(Base):
    ...
    defeitos_principais = Column(JSON)
    defeito_outros_descricao = Column(Text)
    sub_defeitos_refrigeracao = Column(JSON)
    sub_defeitos_compressor = Column(JSON)
    sub_defeitos_vazamento = Column(JSON)
    vazamento_ponto_descricao = Column(Text)
    sub_defeitos_outros_refrig = Column(JSON)
    sub_defeitos_iluminacao = Column(JSON)
    sub_defeitos_estrutura = Column(JSON)
